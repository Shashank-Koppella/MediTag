...
export default function HomeScreen({
  ...
  // Require NFC tap before allowing add
  ...
  // Previous (requested) week tracker style
  const days = [
    { day: "MO", date: "11" },
    { day: "TU", date: "12" },
    { day: "WE", date: "13" }, // show an indicator by tint
    { day: "TH", date: "14" },
    { day: "FR", date: "15" },
    { day: "SA", date: "16", active: true },
    { day: "SU", date: "17" },
    { day: "MO", date: "18" },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] pb-28">
      ...
      <div className="px-6 pt-6 pb-3">
        ...
        {/* Week tracker (previous style, no 'Today' row) */}
        <div className="flex justify-between mt-6">
          {days.map((d, index) => (
            <div key={index} className="text-center">
              <div className="text-xs text-gray-500 mb-2 font-medium">{d.day}</div>
              <div
      ...
      {/* Bottom tab bar: only My Meds, Add +, Setting */}
